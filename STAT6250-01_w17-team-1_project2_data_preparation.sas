...
[Unique ID Schema] The columns “Country” and “City” form a composite key which 
aligns with the composite keys in German population, German O3 & NO2 pollution, 
and in US pollution datasets. 
...
the average pollution level by city the new composite key will be city, state, 
and country in order to merge datasets with the other data sets.
...
be city and country. This is necessary in order to merge with the other 
datasets.
;
