...
footnote2"Using a significance value of .05, both p-values were signficantly higher than the designated significance value. We can conclude there is no correlation between population and NO2 values for either country."
;
